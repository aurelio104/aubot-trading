...
export function loadConfig(): AppConfig {
  ...
  return {
    ...
    maxTradesPerDay: Math.max(0, num("AUBOT_MAX_TRADES_PER_DAY", 1)),
    ...
    capitalPct: num("AUBOT_CAPITAL_PCT", 80),
    reserveUsdt: num("AUBOT_RESERVE_USDT", 3),
...
/** Solo tests — recarga env en memoria. */
export function resetConfigCache(): void {
  cached = null;
}

export function setAutoTrade(enabled: boolean): void {
  getConfig().autoTrade = enabled;
}
